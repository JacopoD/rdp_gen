...
from my_make_blobs import my_make_blobs, weighted_sample_elimination
...
def test_my_blobs():
    ...
    #     n_samples=n_samples, centers=n_components,  cluster_std=0.9,
    ...
    for i in range(len(X)):
        X[i] = weighted_sample_elimination(X[i])
